...
mdtLib = cdll.LoadLibrary("g:/My Drive/Study/Events and Activities/SURP 22/PH07 - Automated NanoOptical measurements/Thorlabs Nanomax/MDT_COMMAND_LIB_x64.dll")
cmdOpen = mdtLib.Open
